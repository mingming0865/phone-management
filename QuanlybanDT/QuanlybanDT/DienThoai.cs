...
namespace QuanlybanDT
{
    public partial class DienThoai : Form
    {
        ...
        private void DienThoai_Load(object sender, EventArgs e)
        {
            ...
            Function.FillCombo(sql, cboMaChatLieu, "MaHang", "TenHang");
        ...
        private void LoadDataGridView()
        {
            ...
            dgvHang.Columns[2].HeaderText = "Hãng";
        ...
        private void dgvHang_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMaHang.Text = dgvHang.CurrentRow.Cells["MaDienThoai"].Value.ToString();
            txtTenHang.Text = dgvHang.CurrentRow.Cells["TenDienThoai"].Value.ToString();
            MaChatLieu = dgvHang.CurrentRow.Cells["MaHang"].Value.ToString();
            sql = "SELECT TenHang FROM Hang WHERE MaHang=N'" + MaChatLieu + "'";
            ...
            sql = "SELECT Anh FROM DienThoai WHERE MaDienThoai=N'" + txtMaHang.Text + "'";
            txtAnh.Text = Function.GetFieldValues(sql);
            picAnh.Image = Image.FromFile(txtAnh.Text);
            sql = "SELECT Ghichu FROM DienThoai WHERE MaDienThoai = N'" + txtMaHang.Text + "'";
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            ResetValues();
            string lastID = GetLastID("DienThoai", "MaDienThoai");
            string nextID = NextID(lastID, "DT");
            txtMaHang.Text = nextID;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn phải chọn ảnh minh hoạ cho đt", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                btnOpen.Focus();
                return;
            }
            sql = "SELECT MaDienThoai FROM DienThoai WHERE MaDienThoai=N'" + txtMaHang.Text.Trim() + "'";
            ...
            sql = "INSERT INTO DienThoai(MaDienThoai,TenDienThoai,MaHang,SoLuong,DonGiaNhap, DonGiaBan,Anh,Ghichu) VALUES(N'"
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (txtAnh.Text.Trim().Length == 0)
            {
                MessageBox.Show("Bạn phải ảnh minh hoạ cho đt", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtAnh.Focus();
                return;
            }
            sql = "UPDATE DienThoai SET TenDienThoai=N'" + txtTenHang.Text.Trim().ToString() +
                "',MaHang=N'" + cboMaChatLieu.SelectedValue.ToString() +
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE DienThoai WHERE MaDienThoai=N'" + txtMaHang.Text + "'";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaHang.Text != "")
                sql += " AND MaDienThoai LIKE N'%" + txtMaHang.Text + "%'";
            if (txtTenHang.Text != "")
                sql += " AND TenDienThoai LIKE N'%" + txtTenHang.Text + "%'";
            if (cboMaChatLieu.Text != "")
                sql += " AND MaHang LIKE N'%" + cboMaChatLieu.SelectedValue + "%'";
            tblH = Function.GetDataToTable(sql);
            if (tblH.Rows.Count == 0)
