...
namespace QuanlybanDT.Class
{
    class Function
    {
        ...
        public static string conString= @"Data Source=DESKTOP-JHK0FPO\SQLEXPRESS;Initial Catalog=QuanLybanDT;Integrated Security=True";//Chuoi ket noi dung chung
        public static void Connect()
        {
            Con = new SqlConnection();   //Khởi tạo đối tượng
            Con.ConnectionString = @"Data Source=DESKTOP-JHK0FPO\SQLEXPRESS;Initial Catalog=QuanLybanDT;Integrated Security=True";
            Con.Open();                  //Mở kết nối
            //Kiểm tra kết nối
